...
const Footer = () => {
  return (
    <div className="bg-[#0E0A19] p-10">
      <div className="flex flex-col md:flex-row md:flex-wrap justify-between">
        <NavLink
          to="/"
          className="text-[20px] md:text-[24px] lg:text-[32px] text-[#FBFF62] font-medium mx-3"
        >
          Home
        </NavLink>
        <NavLink
      ...
      <div className="mt-60 flex justify-between">
        <div className="">
          <h3 className="text-[#FBFF62] text-3xl font-bold">
            Let's Connect <br />& Chat
          </h3>
        ...
        <div className="">
          ...
          <div className="gap-4 mt-10">
            <p className="text-white">Mirbag, Dhaka-1217</p>
            <p className="text-[#ffffff60]">©2024CrowdClub</p>
          </div>
        </div>
      </div>
    </div>
